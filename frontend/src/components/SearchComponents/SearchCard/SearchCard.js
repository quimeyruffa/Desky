    ...
    return (
        <div className="main-container">
            <div className={"Scard " + props.className}>
                ...
                <div className="ver">
                    <Button onClick={()=>props.handleClick({nombre: props.nombre, direccion: props.direccion, amenities: props.amenities, tipo: props.tipo, precio: props.precio, idCowork: props.idCowork, idOficina: props.idOficina})} className="btn-ver">VER</Button>
